import math
import torch
from kornia.feature.dedode.vgg import vgg19
...
class LPIPSloss(nn.Module):
    def __init__(self, loss_weight=1.0):  # 'alex' | 'squeeze' | 'vgg'. Default: 'alex'.
    ...
    def forward(self, pred, target, **kwargs):
        ...
        return self.loss_weight * self.lpips_loss(pred, target).sum()
...
class EnhanceLoss(nn.Module):
    ...
    def forward(self, gt, enhanced, scale_factor=8):
